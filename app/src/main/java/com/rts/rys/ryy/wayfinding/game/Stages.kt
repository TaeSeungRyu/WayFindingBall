...
object Stages {
    ...
    private val specs: List<StageSpec>
        get() = listOf(
            ...
            // 스테이지10 — 13x13 (최종 보스: 동적 벽 + 도착점 이동 + 어둠 + 추격자 + 별)
            stage(10, listOf(
                "#############",
                "#S    *     #",
                "# ######### #",
            ...
            // 스테이지14 — 무한 모드 (실제 미로는 게임 진입 시 매번 랜덤 생성)
            stage(14, listOf(
                "#############",
                "#S          #",
                "#           #",
            ...
            // 스테이지15 — 생존 모드 (21x21 랜덤, 적 증가, 폭탄으로 적 제거)
            stage(15, listOf(
                "#####################",
                "#S                  #",
                "#                   #",
            ...
            // 스테이지16 — 얼음 미로 (13x13 랜덤, 마찰 낮음, 클리어 시 라운드++)
            stage(16, listOf(
                "#############",
                "#S          #",
                "#           #",
            ...
            // 스테이지17 — 타는 길 (13x13 랜덤, 지나간 셀이 1.5초 후 벽으로)
            stage(17, listOf(
                "#############",
                "#S          #",
                "#           #",
            ...
            // 스테이지18 — 공이 커져요 (13x13 랜덤, 라운드마다 공 크기 증가)
            stage(18, listOf(
                "#############",
                "#S          #",
                "#           #",
            ...
            // 스테이지19 — 열쇠를 찾아요 (13x13 랜덤, 열쇠 N개 수집해야 문 열림)
            stage(19, listOf(
                "#############",
                "#S          #",
                "#           #",
            ...
            // 스테이지20 — 내 그림자 미로 (13x13 랜덤, 지나간 경로를 그림자가 추격)
            stage(20, listOf(
                "#############",
                "#S          #",
                "#           #",
