...
private val GearTheme = MazeTheme(
    wallTop = Color(0xFFCFD5DA),
    wallMid = Color(0xFF7A8693),
    wallDeep = Color(0xFF3A434E),
    wallAccent = Color(0xFFEEF1F4),
    floorTile = Color(0xFFE3E6EA),
    floorTileAlt = Color(0xFFCBD0D7),
    floorDetailDot = Color(0xFF8A95A2),
    floorDetailSplotch = Color(0xFFB6BDC6),
    skyTop = Color(0xFFB8C3CC),
    skyBottom = Color(0xFF5E6B78),
    rockTop = Color(0xFF9098A4),
    rockBottom = Color(0xFF4C545E),
    flowerColors = listOf(Color(0xFFFFD24A), Color(0xFFFF9F1C), Color(0xFFB9E2FF)),
    flowerCenter = Color(0xFFFFE066),
    cloudOpacity = 0.7f
)

private val GoldenTheme = MazeTheme(
    wallTop = Color(0xFFFFD24A),
    wallMid = Color(0xFFD97742),
    wallDeep = Color(0xFF6E3C1A),
    wallAccent = Color(0xFFFFE99A),
    floorTile = Color(0xFFFFF6D6),
    floorTileAlt = Color(0xFFF4E2A8),
    floorDetailDot = Color(0xFFBE8A40),
    floorDetailSplotch = Color(0xFFE6CC88),
    skyTop = Color(0xFFFFD0A6),
    skyBottom = Color(0xFFFF8A54),
    rockTop = Color(0xFFC4A07A),
    rockBottom = Color(0xFF7B5A38),
    flowerColors = listOf(Color(0xFFFFC1CC), Color(0xFFFFE066), Color(0xFFCDE7FF)),
    flowerCenter = Color(0xFFFFE066),
    cloudOpacity = 0.7f
)
...
private val CandyTheme = MazeTheme(
    ...
    wallMid = Color(0xFFE07898),
    wallDeep = Color(0xFF8A2D4A),
    wallAccent = Color(0xFFFFE0E8),
    floorTile = Color(0xFFFFF5F0),
    floorTileAlt = Color(0xFFFFE0E0),
    floorDetailDot = Color(0xFFD8A0B0),
    floorDetailSplotch = Color(0xFFFFD0D8),
    skyTop = Color(0xFFFFD8E8),
    skyBottom = Color(0xFFFFA8C0),
    rockTop = Color(0xFFD0A8C0),
    rockBottom = Color(0xFF8A6080),
    flowerColors = listOf(Color(0xFFFFC1CC), Color(0xFFFFE066), Color(0xFFA5D4FF)),
    flowerCenter = Color(0xFFFFE066),
    cloudOpacity = 1f
)

private val LavaTheme = MazeTheme(
    wallTop = Color(0xFFFFA040),
    wallMid = Color(0xFFC23A14),
    wallDeep = Color(0xFF5A0A02),
    wallAccent = Color(0xFFFFD080),
    floorTile = Color(0xFF2A0E08),
    floorTileAlt = Color(0xFF1A0604),
    floorDetailDot = Color(0xFFB04020),
    floorDetailSplotch = Color(0xFF3A1810),
    skyTop = Color(0xFF5A0A02),
    skyBottom = Color(0xFF1A0202),
    rockTop = Color(0xFF8A3A1A),
    rockBottom = Color(0xFF3A1408),
    flowerColors = listOf(Color(0xFFFFD24A), Color(0xFFFF6A2C), Color(0xFFFFE7A0)),
    flowerCenter = Color(0xFFFFE066),
    cloudOpacity = 0.3f,
    isDark = true
)

private val EclipseTheme = MazeTheme(
    wallTop = Color(0xFF2E3340),
    wallMid = Color(0xFF161A26),
    wallDeep = Color(0xFF02030A),
    wallAccent = Color(0xFF505870),
    floorTile = Color(0xFF101220),
    floorTileAlt = Color(0xFF080A14),
    floorDetailDot = Color(0xFF3A4258),
    floorDetailSplotch = Color(0xFF1A1E2C),
    skyTop = Color(0xFF0A0E1C),
    skyBottom = Color(0xFF02030A),
    rockTop = Color(0xFF353B4C),
    rockBottom = Color(0xFF14182A),
    flowerColors = listOf(Color(0xFFB8C0E0), Color(0xFFDDE3F8), Color(0xFF606878)),
    flowerCenter = Color(0xFFE0E5F4),
    cloudOpacity = 0f,
    isDark = true
)
